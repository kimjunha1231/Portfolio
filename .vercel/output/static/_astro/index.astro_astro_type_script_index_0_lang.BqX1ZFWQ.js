const g = {
	1: {
		title: "Dearfam : 가족의 이야기를 담아드립니다", period: "2024.11 ~ 현재", role: `
			<ul>
				<li>프론트엔드 리드 담당</li>
		...
		title: "TITO 토론 보조 서비스", period: "2024.03 ~ 2024.12", role: `
			<ul>
      ...
      <ul>
		...
		title: "여행의 이유", period: "2024.01.10 ~ 2024.02.19", role: `
			<ul>
        ...
        <ul>
           <li style="margin-left: 2rem;">백엔드 연동 전 MSW사용으로 코드 변동이 최소화, 추후 통신 방법만 변경하여 빠르게 기능 구현</li>
          </ul>
        </li>
		...
		title: "융합특성화 자유전공학부 커뮤니티 SSYUNG", period: "2021.01.03 ~ 2021.03.07", role: `
			<ul>
		...
		title: "POPPET - 노약자를 위한 AI 말동무 서비스", period: "2025.05.20 ~ 현재", role: `
			<ul>
